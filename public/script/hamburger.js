...
document.querySelector(".hamburger_btn").addEventListener("click", () => {
    ...
    document.querySelector(".hamburgerBox").classList.add("hamburger_pop");
    document.querySelector(".hamburgerBox").classList.add("unblur");
    document.querySelector(".hamburgerBox").classList.remove("hamburger_close");
})
...
document.querySelector(".cross_btn").addEventListener("click", () => {
    ...
    document.querySelector(".hamburgerBox").classList.add("hamburger_close");
    document.querySelector(".hamburgerBox").classList.remove("hamburger_pop");
})
